...
export const asyncRoutes = [
  {
    ...
    children: [
      ...
      // CMS 文章
      {
        ...
        meta: { title: '文章列表', perm: 'cms.article.view' },
      },
      {
        path: 'cms/articles/create',
        component: () => import('@/views/cms/ArticleEdit.vue'),
        meta: { title: '新增文章', perm: 'cms.article.edit', hidden: true },
      },
      {
        path: 'cms/articles/edit/:id',
        component: () => import('@/views/cms/ArticleEdit.vue'),
        meta: { title: '编辑文章', perm: 'cms.article.edit', hidden: true },
      },

      // 首页装修
      {
        path: 'decorate/home',
        component: () => import('@/views/decorate/DecorateHome.vue'),
        meta: { title: '首页装修', perm: 'decorate.view' },
      },
