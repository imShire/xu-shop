...
export const centsToYuan = (cents) => (cents / 100).toFixed(2);
export const yuanToCents = (yuan) => Math.round(Number(yuan) * 100);
...
export const formatAmount = (cents) => `¥${centsToYuan(cents)}`;
