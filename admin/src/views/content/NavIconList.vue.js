...
import { getNavIcons, createNavIcon, updateNavIcon, deleteNavIcon, toggleNavIcon, sortNavIcons, } from '@/api/nav-icon';
...
async function handleDelete(row) {
    await ElMessageBox.confirm(`确认删除金刚区图标「${row.title || row.id}」？`, '提示', { type: 'warning' });
...
__VLS_15.slots.default;
{
    ...
    const __VLS_23 = {
        onClick: (...[$event]) => {
            __VLS_ctx.handlePreview(row.icon_url);
        }
    };
    var __VLS_19;
}
...
var __VLS_11;
if (!__VLS_ctx.navIcons.length && !__VLS_ctx.loading) {
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ style: {} },
    });
...
const __VLS_81 = __VLS_asFunctionalComponent(__VLS_80, new __VLS_80({
    ...
    title: (__VLS_ctx.isEdit ? '编辑图标' : '新增图标'),
    width: "480px",
    destroyOnClose: true,
}));
...
const __VLS_94 = __VLS_asFunctionalComponent(UploadImage, new UploadImage({
    modelValue: (__VLS_ctx.form.icon_url),
}));
